...
- [Unicode Ethereum Project](https://github.com/devstein/unicode-eth) - An initiative to provide libraries and contracts for Unicode data, algorithms, and utilities for Ethereum developers.
