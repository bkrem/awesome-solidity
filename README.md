...
- [Programming Hyperledger Fabric](https://www.manning.com/books/programming-hyperledger-fabric) - A guide to solving the problems of deploying blockchain apps to production.
